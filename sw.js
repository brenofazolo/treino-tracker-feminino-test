const CACHE='treino-feminino-test-v8';
const ASSETS=['./index.html','./manifest.json','./config-tools.js','./history-tools.js','./workout-input-tools.js','./block-workout-tools.js','./female-enhancements.js'];
